...
cout<<" bugunun tarihini gun ay yil seklinde giriniz:"<<endl;
cin>>bugun.gun>>bugun.ay>>bugun.yil;
cout<<"dogum gununuzu gun ay yil seklinde giriniz:"<<endl;
cin>>dogum.gun>>dogum.ay>>dogum.yil;
sonuc=yashesapla(bugun,dogum);
cout<<sonuc.yil<<sonuc.ay<<sonuc.gun<<" gun gecmis";	
